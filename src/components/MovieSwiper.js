    ...
    <div name="picks" className='w-full md:h-screen bg-[#141d2b] text-white'>
      <div className="mx-[34rem] px-5 flex flex-col justify-center h-full">
        ...
        <div className="movie-card">
          <div className="movie-details grid grid-rows-4 grid-flow-col gap-4">
          ...
          <div className="swipe-buttons flex justify-center gap-10 pt-24">
            <button
              className="leftButton rounded bg-[#b45050] px-12 py-3 text-sm font-medium text-white hover:bg-[#b4505070] hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto"
            ...
            <button className="rightButton rounded bg-[#50b49b] px-12 py-3 text-sm font-medium text-white hover:bg-[#50b49b86] hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto" onClick={() => handleSwipe("right")}>Swipe right</button>
          </div>
        </div>
      </div>
    </div>
